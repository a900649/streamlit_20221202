...
def reload_electricity_data():
    ...
    for i in range(104, 112):
        filename = os.path.dirname(os.path.abspath(__file__)) + "\\" + "用電統計資料\\{}.csv".format(str(i))
...
def show_path():
    ...
    filename = os.path.dirname(os.path.abspath(__file__)) + "\\" + "用電統計資料\\{}.csv".format(str(104))
    file_exist = os.path.isfile(filename)
    st.header(str(file_exist))

    filename = os.path.dirname(os.path.abspath(__file__)) + "\\" + "用電統計暫存資料\\用電統計.pkl"
    file_exist = os.path.isfile(filename)
    st.header(str(file_exist))
